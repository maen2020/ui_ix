...
class OnboardController extends ChangeNotifier {
  final List<OnboardItem> items = [
    ...
    OnboardItem(
      ...
      title: 'At consectetur lorem donec massa sapien',
      description:
          'Non quam lacus suspendisse faucibus interdum posuere lorem ipsum dolor. Sapien nec sagittis aliquam malesuada.',
    ),
  ];
